#!/bin/bash
rm /etc/jitsi/meet/$HOST-config.js
cat  > /etc/jitsi/meet/$HOST-config.js <<EOF;
...
var config = {
    ...
    hosts: {
        ...
        // jirecon: 'jirecon.$HOST',

        // Call control component (Jigasi).
        // call_control: 'callcontrol.$HOST',
